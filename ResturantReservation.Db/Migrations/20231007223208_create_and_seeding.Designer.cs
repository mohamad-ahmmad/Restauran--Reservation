...
namespace ResturantReservation.Db.Migrations
{
    ...
    [Migration("20231007223208_create_and_seeding")]
    partial class create_and_seeding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ResturantReservation.Db.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            EmployeeId = 1,
                            OrderDate = new DateTime(2023, 10, 8, 1, 32, 8, 371, DateTimeKind.Local).AddTicks(360),
                            ReservationId = 1,
                            TotalAmount = 10.3m
                        },
                        new
                        {
                            OrderId = 2,
                            EmployeeId = 3,
                            OrderDate = new DateTime(2023, 9, 28, 1, 32, 8, 371, DateTimeKind.Local).AddTicks(364),
                            ReservationId = 3,
                            TotalAmount = 30.3m
                        },
                        new
                        {
                            OrderId = 3,
                            EmployeeId = 2,
                            OrderDate = new DateTime(2023, 9, 18, 1, 32, 8, 371, DateTimeKind.Local).AddTicks(366),
                            ReservationId = 2,
                            TotalAmount = 30.3m
                        },
                        new
                        {
                            OrderId = 4,
                            EmployeeId = 3,
                            OrderDate = new DateTime(2023, 10, 8, 1, 32, 8, 371, DateTimeKind.Local).AddTicks(368),
                            ReservationId = 4,
                            TotalAmount = 70.3m
                        });
                });
            ...
            modelBuilder.Entity("ResturantReservation.Db.Entities.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = 1,
                            PartySize = 3,
                            ReservationDate = new DateTime(2023, 10, 8, 1, 32, 8, 371, DateTimeKind.Local).AddTicks(303),
                            RestaurantId = 1,
                            TableId = 1
                        },
                        new
                        {
                            ...
                            CustomerId = 2,
                            PartySize = 4,
                            ReservationDate = new DateTime(2023, 10, 11, 1, 32, 8, 371, DateTimeKind.Local).AddTicks(341),
                            RestaurantId = 1,
                            TableId = 2
                        },
                        new
                        {
                            ...
                            CustomerId = 3,
                            PartySize = 4,
                            ReservationDate = new DateTime(2023, 10, 8, 1, 32, 8, 371, DateTimeKind.Local).AddTicks(344),
                            RestaurantId = 2,
                            TableId = 4
                        },
                        new
                        {
                            ...
                            CustomerId = 5,
                            PartySize = 4,
                            ReservationDate = new DateTime(2023, 9, 18, 1, 32, 8, 371, DateTimeKind.Local).AddTicks(345),
                            RestaurantId = 2,
                            TableId = 5
                        },
                        new
                        {
                            ...
                            CustomerId = 1,
                            PartySize = 3,
                            ReservationDate = new DateTime(2023, 8, 8, 1, 32, 8, 371, DateTimeKind.Local).AddTicks(347),
                            RestaurantId = 1,
                            TableId = 1
                        });
                });
            ...
            modelBuilder.Entity("ResturantReservation.Db.Entities.Order", b =>
                {
                    ...
                    b.HasOne("ResturantReservation.Db.Entities.Reservation", "Reservation")
                        .WithOne("Order")
                        .HasForeignKey("ResturantReservation.Db.Entities.Order", "ReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
